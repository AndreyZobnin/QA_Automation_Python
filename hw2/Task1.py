#Задание1. Дополнить проект тестами, проверяющими команды вывода списка файлов (l) и разархивирования с путями (x)

from seminar2.test.checker import checkout

source_folder = "/home/andrey/PycharmProjects/AutoQA/hw2/files/source"
result_folder = "/home/andrey/PycharmProjects/AutoQA/hw2/files/result"
arc_folder = "/home/andrey/PycharmProjects/AutoQA/hw2/files/archives"
arc = "arc_hw2.7z"
file1 = "hw2_test_1"
test_folder = "test"
file2 = "hw2_test_2"
